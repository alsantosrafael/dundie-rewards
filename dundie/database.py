...
def connect():
    """Connects to the database and returns dict data"""
    try:
...
def set_initial_password(db, pk):
    """Set initial password and save it to the user"""
...
def set_initial_balance(db, pk, person):
    """Adds movement and set initial balance"""
...
def add_movement(db, pk, value, actor="system"):
    ...
    Example::
        ...
        add_movement(db, "me@me.com.br", 100, "me")
